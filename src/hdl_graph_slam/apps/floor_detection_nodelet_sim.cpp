...
class FloorDetectionNodelet_sim : public nodelet::Nodelet {
public:
  typedef pcl::PointXYZI PointT;
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW

  FloorDetectionNodelet_sim() {}
  virtual ~FloorDetectionNodelet_sim() {}
  ...
  virtual void onInit() {
    ...
    points_sub = nh.subscribe("/filtered_points", 256, &FloorDetectionNodelet_sim::cloud_callback, this);
...
PLUGINLIB_EXPORT_CLASS(hdl_graph_slam::FloorDetectionNodelet_sim, nodelet::Nodelet)
